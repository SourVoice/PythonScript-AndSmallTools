...
# time.clock() # 用这一语句会报错:DeprecationWarning: time.clock has been deprecated in Python 3.3 and will be removed from
# Python 3.8: use time.perf_counter or time.process_time instead
# 改用下面的语句:
time.process_time()
